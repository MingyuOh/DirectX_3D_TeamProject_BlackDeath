...
public:
	...
	TVector3 GetLeftHandGunPostion(int iResouceNumber);
	TMatrix* GetLeftHandGunMatrixWorld(int iResouceNumber);
	TVector3 GetRightHandGunPosition(int iResouceNumber);
	TMatrix* GetRightHandGunMatrixWorld(int iResouceNumber);
