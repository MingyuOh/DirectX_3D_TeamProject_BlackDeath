...
public:
	//hero
	bool CreateHero(TVector3 vHeroPosition, int iTableIndex);
	LAHero* GetHero();
	bool DeleteHero(int iIndex);

	//monster
	bool CreateMonster(TVector3 vHeroPosition, int iTableIndex);
	...
	//Weapon
	bool CreateWeapon(TVector3 vHeroPosition, int iTableIndex, int iBulletCount);
	int GetWeaponSize();
	...
	//Armor
	bool CreateArmor(TVector3 vHeroPosition, int iTableIndex);
