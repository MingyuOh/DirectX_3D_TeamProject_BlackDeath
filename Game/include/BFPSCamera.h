...
public:
	...
	D3DXVECTOR3		m_vMapNormal;			// 맵 노말
	D3DXVECTOR3		m_vHeroLook;			// 히어로 Look벡터
	D3DXVECTOR3		m_vHeroUp;				// 히어로 Up벡터
	D3DXVECTOR3		m_vHeroSide;			// 히어로 Side벡터
	D3DXVECTOR3		m_vBeforeCameraPos;		// 카메라 이전위치 
	bool			m_bCheckMap;			// 맵의 갈 수있는 지형 체크
public:
	//--------------------------------------------------------------------------------------
	// 히어로 포지션 셋팅 함수
	//--------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------
	void SetMapNormal(D3DXVECTOR3 vMapNormal);
	//--------------------------------------------------------------------------------------
	// FPS 카메라 미끌림 처리 함수
	//--------------------------------------------------------------------------------------
