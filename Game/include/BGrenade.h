...
{
public:
	BBoundingBox	m_BoundingBox;				// 수류탄 충돌바운딩박스(테스트용)
	float			m_fHeight;					// 수류탄 높이
	float			m_fVelocity;				// 수류탄 속도
	float			m_fAngle;					// 수류탄 날아가는 각도
	bool			m_bTrigger;					// 수류탄 트리거
	D3DXVECTOR3		m_vGrenadeDir;				// 수류탄 방향
	D3DXVECTOR3		m_vGrenadePos;				// 수류탄 위치

	D3DXVECTOR3		m_vVelocity;				// 수류탄 현재 속도
	D3DXVECTOR3		m_vFirstGrenadePos;			// 수류탄 초기 위치
